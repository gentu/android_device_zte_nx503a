...
$(call add-clean-step, find $(OUT_DIR) -name "lights.msm8974*" -print0 | xargs -0 rm -f)
...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/NX503A/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/NX503A/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/NX503A/recovery/root/default.prop)
